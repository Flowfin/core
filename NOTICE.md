...
in it is designed to enable such use. The core is offered under
`MIT OR Apache-2.0`, and each of the two texts, [LICENSE-MIT](LICENSE-MIT) and
[LICENSE-APACHE](LICENSE-APACHE), contains the full warranty and liability
disclaimer.
