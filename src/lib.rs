...
const _: () = {
    ...
    any_thread::<playback::handover::StreamKind>();
    any_thread::<playback::handover::Picture>();
    any_thread::<playback::handover::OfferedStream>();
    any_thread::<playback::handover::RoutesOffered>();
    any_thread::<playback::handover::ConversionAddress>();
    any_thread::<playback::handover::OfferedSource>();
    any_thread::<playback::handover::WhatTheServerOffered>();
    any_thread::<playback::handover::Rung>();
    any_thread::<playback::handover::Ceiling>();
    any_thread::<playback::handover::Preferences<'static>>();
    any_thread::<playback::handover::ChosenStream>();
    any_thread::<playback::handover::WhatThePlayerOpens>();
    any_thread::<playback::handover::Handover>();
    any_thread::<playback::handover::NothingPlayable>();
